...
ssr_control <- create_ssr_control(X_names=c("smooth_log_cases", "time_ind"),
    ...
    max_lag=list(smooth_log_cases=1,
        time_ind=0),
    prediction_horizons=seq_len(prediction_horizon_limit),
...
save(ssr_fit,
    file=paste0("/home/er71a/ssr-competition/fit-competition-ssr-ph", prediction_horizon_limit, "-", data_set, ".Rdata"))
