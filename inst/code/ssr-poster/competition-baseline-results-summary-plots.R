...
load("/media/evan/data/Reich/dengue-ssr-prediction/inst/intermediate-results/ssr-poster/predictions/competition-baseline-sarima-predictions.Rdata")

ssr_predictions_df$model <- "ssr"

predictions_df <- rbind.fill(ssr_predictions_df, competition_baseline_sarima_predictions_df)
